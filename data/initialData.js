...
/**
 * โครงสร้างค่าตอบแทนของเจ้าหน้าที่ CNO
 *
 * - เงินเดือนเป็นก้อนคงที่ต่อเดือน ไม่ผันตามชั่วโมงที่ลงกะ
 * - hourlyRate ใช้เป็นฐานคิด OT เท่านั้น (41,000 / 170.8 ≈ 240 ชม./เดือน)
 * - ค่ากะและค่าแท็กซี่ผูกกับ "กะที่ลงจริง" กะเช้า (1) และกะปกติ (A) ไม่ได้ทั้งสองอย่าง
 * - HT1/HT2/HT3 นับเป็น OT และยังได้ค่ากะ/ค่าแท็กซี่ตามกะฐานของมันด้วย
 */
export const COMPENSATION_DEFAULT = {
  monthlySalary: 41000,
  hourlyRate: 170.8,
  shiftHours: 8,
  // ค่ากะ (บาท/กะ)
  shiftAllowance: { '1': 0, '2': 60, '3': 80, 'A': 0 },
  // ค่าแท็กซี่ (บาท/กะ) — กะบ่ายได้ค่ากลับบ้าน กะดึกได้ค่ามาทำงาน
  taxiAllowance: { '1': 0, '2': 150, '3': 150, 'A': 0 },
  // ตัวคูณ OT ของกะ HT ตาม OT_CLAIM_RULES ข้อ "OT วันหยุด (ตรง NORM) = 1 แรง"
  otMultiplier: 1.0
};
