...
// Staff 1 (ธีระกิจ) & Staff 2 (วรพงษ์): Fixed at Shift A on weekdays (Mon-Fri), Day Off (H) on weekends
...
export const INITIAL_OCTOBER_ROSTER = {
  // 1. ธีระกิจ พรมตุ้ม (กะ A วันทำงาน, H วันหยุดเสาร์-อาทิตย์)
  1: ['A','A','A','H','H','A','A','A','A','A','H','H','A','A','A','A','A','H','H','A','A','A','A','A','H','H','A','A','A','A','A'],
  // 2. วรพงษ์ ริมสกุล (กะ A วันทำงาน, H วันหยุดเสาร์-อาทิตย์)
  2: ['A','A','A','H','H','A','A','A','A','A','H','H','A','A','A','A','A','H','H','A','A','A','A','A','H','H','A','A','A','A','A'],
...
export const DC_SETTINGS_DEFAULT = {
  minStaffPerShift: {
    'A': 2, // ธีระกิจ & วรพงษ์ ยืนกะ A วันทำงาน
    '1': 1, // Morning min 1 คน
